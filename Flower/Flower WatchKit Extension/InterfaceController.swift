...
class InterfaceController: WKInterfaceController {
    ...
    @IBAction func longPressAction(_ gestureRecognizer: WKLongPressGestureRecognizer) {
        if gestureRecognizer.state == .began{
            timer_press = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector (InterfaceController.counter_press), userInfo: nil, repeats: true)
